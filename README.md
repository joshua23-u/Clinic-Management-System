...
| ✔️ **Reliability** | The system shall accurately prevent double-booking of the same doctor, date, and time slot. |
...
| **Member 4** | ⚙️ Non-Functional Lead | Identify and document non-functional requirements (performance, security, usability). |
| **Member 5** | 📝 Documentation & Quality | Compile the requirements report, proofread, format the document, maintain version control. |
| **Member 6** | 🛠️ Tools & Presentation Lead | Research and set up agreed tools/techniques; prepare slides for the requirements presentation. |
...
### 5.1 🗣️ Interviews & Brainstorming (Requirements Gathering)
